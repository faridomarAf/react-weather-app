                ...
                <div className="grid gap-6 md:grid-cols-2">
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-1">
                            <h2 className="font-bold text-xl tracking-tighter">{locationName?.name}</h2>
                            {locationName?.state &&(
                        ...
                        <div className="flex items-center gap-2">
                            <p className="text-4xl font-bold tracking-tighter">{formatTemp(temp)}</p>
                    ...
                    <div>
                        <div className="relative flex aspect-square w-full max-w-[200px] items-center justify-center">
                            ...
                            <div className="absolute bottom-0 text-center">
                                <p className="font-medium text-sm capitalize">{currentWeather.description}</p>
                            </div>
                        </div>
                    </div>
                </div>
